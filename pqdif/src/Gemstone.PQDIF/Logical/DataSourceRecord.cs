...
namespace Gemstone.PQDIF.Logical
{
    ...
    public class DataSourceRecord
    {
        ...
        /// </summary>
        public string DataSourceSerialNumber
        {
            get
            {
                CollectionElement collectionElement = m_physicalRecord.Body.Collection;
                VectorElement dataSourceNameElement = collectionElement.GetVectorByTag(DataSourceSerialNumberTag)
                    ?? throw new InvalidDataException("DataSourceName element not found in data source record.");
        ...
        /// <summary>
        /// Tag that identifies the data source serial number.
        /// </summary>
        public static Guid DataSourceSerialNumberTag { get; } = new("b48d8585-f5f5-11cf-9d89-0080c72e70a3");
